        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengelolaan</span> Kamar Indekos</h4>
                  ...
                  <div class="row">
                      ...
                      <div class="col-6 col-md-6 col-sm-12">
                        <h5 class="card-header float-end">
                            <a href="/admin/kamar/tambah" class="btn btn-md btn-outline-primary p-2"><i class="menu-icon tf-icons bx bx-plus"></i>Tambah</a>
                        </h5>
                          
                      </div>
                  </div>
                <div class="table-responsive text-nowrap p-3">
                  <table class="table table-hover table-borderless" id="datatabel" style="table-layout: fixed;">
                    <thead>
                      <tr>
                        <th>Nama Kamar</th>
                        <th>Deskripsi</th>
                    ...
                    <tbody class="table-border-bottom-0">
                      @foreach ($dataallkamar as $kamar)
                      <tr>
                        <td><strong>{{ $kamar->nama_kamar }}</strong></td>
                        <td style="overflow: hidden; text-overflow: ellipsis">{{ $kamar->deskripsi }}</td>
                        <td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="/admin/kamar/detail/{{$kamar->id_kamar}}"
                                ><i class="bx bx-show-alt me-1"></i> Detail</a
                              >
                              <a class="dropdown-item" href="/admin/kamar/edit/{{$kamar->id_kamar}}"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalKamar-{{$loop->iteration}}"
                      ...
                      <!-- modal delete -->
                      <div class="modal fade" id="modalKamar-{{$loop->iteration}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              Apakah anda yakin ingin menghapus kamar <strong>{{ $kamar->nama_kamar }}</strong> ?
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                                Close
                              </button>
                              <form action="{{ url('/admin/kamar/' . $kamar->id_kamar) }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
