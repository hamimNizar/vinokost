        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tambah</span> Penyewaan Indekos</h4>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Form Tambah Penyewaan</h5>
                                <a href="{{ URL::previous() }}" class="btn btn-md btn-outline-secondary float-end"><i class="bx bx-undo"></i> Kembali</a>
                            </div>
                            <div class="card-body">
                            <form action="{{ url('admin/penyewaan') }}" method="POST" enctype="multipart/form-data">
                              @csrf
                                <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control @error('mulai_sewa') is-invalid @enderror" id="mulai_sewa" name="mulai_sewa" />
                                    @error('mulai_sewa')
                                    <div class="invalid-feedback">
                                          {{ $message }}
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control @error('akhir_sewa') is-invalid @enderror" id="akhir_sewa" name="akhir_sewa" />
                                    @error('akhir_sewa')
                                    <div class="invalid-feedback">
                                          {{ $message }}
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="number" id="jumlah" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror" value="500000" />
                                    @error('jumlah')
                                    <div class="invalid-feedback">
                                          {{ $message }}
                                    </div>
