        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tambah</span> Penghuni Indekos</h4>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Form Tambah Penghuni</h5>
                                <a href="{{ URL::previous() }}" class="btn btn-md btn-outline-secondary float-end"><i class="bx bx-undo"></i> Kembali</a>
                            </div>
                            <div class="card-body">
                            <form action="{{ url('admin/penghuni') }}" method="POST" enctype="multipart/form-data">
                              @csrf
                                <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Penghuni</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('nama_user') is-invalid @enderror" id="nama_user" name="nama_user" placeholder="Masukkan Nama Penghuni"/>
                                    @error('nama_user')
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Masukkan Email" aria-label="john.doe" aria-describedby="email" />
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="no_telepon" name="no_telepon" class="form-control phone-mask @error('no_telepon') is-invalid @enderror" placeholder="Masukkan No. Telepon" aria-label="658 799 8941"aria-describedby="basic-default-phone" />
                                    @error('no_telepon')
                                    <div class="invalid-feedback">
                                          {{ $message }}
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="username" name="username" class="form-control @error('username') is-invalid @enderror" aria-label="658 799 8941" aria-describedby="basic-default-phone" placeholder="Masukkan Username"/>
                                    @error('username')
                                    <div class="invalid-feedback">
                                          {{ $message }}
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                      <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="············" aria-describedby="basic-default-password">
