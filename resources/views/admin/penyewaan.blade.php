        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">Penyewaan Kamar Vinokost</h4>

              <!-- Hoverable Table rows -->
              <div class="card">
                  <div class="row">
                      <div class="col-6 col-md-6 col-sm-12">
                          <h5 class="card-header">Penyewaan Kamar</h5>
                      </div>
                      <div class="col-6 col-md-6 col-sm-12">
                        <h5 class="card-header float-end">
                            <a href="/admin/penyewaan/tambah" class="btn btn-md btn-outline-primary p-2"><i class="menu-icon tf-icons bx bx-plus"></i>Tambah</a>
                        </h5>
                ...
                <div class="table-responsive text-nowrap p-3">
                  <table class="table table-hover table-borderless" id="datatabel">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td><strong>{{$penyewaan->nama_kamar}}</strong></td>
                        <td>{{$penyewaan->nama_user}}</td>
                        <td>{{$penyewaan->mulai_sewa}}</td>
                        <td>{{$penyewaan->akhir_sewa}}</td>
                        <?php


                          $datetime1 = date_create(date('Y-m-d'));
                          $datetime2 = date_create($penyewaan->akhir_sewa);
                          //hitung jarak tanggal sewa
                          $interval = date_diff($datetime2, $datetime1);
                        ?>
                        <td><span class="badge bg-label-primary">{{ $interval->format('%R %m bulan %d hari') }}</span></td>
                        <td>{{$penyewaan->keterangan}}</td>
                        <td><a href="/admin/penyewaan/detail/{{ $penyewaan->id_penyewaan }}"><span class="badge badge-center bg-primary me-1"><i class='bx bxs-edit'></i></span></a></td>
                      </tr>     
                      @endforeach               
                    </tbody>
                  </table>
