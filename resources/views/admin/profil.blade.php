        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Informasi</span> Detail Admin Vinokost</h4>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Akun Pengelola Vinokost</h5>
                                <a href="" class="btn btn-md btn-outline-secondary float-end"><i class="bx bx-undo"></i> Kembali</a>
                            </div>
                            <div class="card-body">
                            <form method="POST" action="{{ url('admin/profil/' . $dataadmin[0]->id_user)}}" enctype="multipart/form-data">
                              @method('patch')
                              @csrf
                                <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Pengelola</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_user" name="nama_user" value="{{$dataadmin[0]->nama_user}}"/>
                                </div>
                                </div>
                                <div class="row mb-3">
