        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Detail</span> Kamar Indekos</h4>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="exampleFormControlReadOnlyInputPlain1" class="form-label">Nama Kamar</label>
                                    <input type="text" readonly="" class="form-control-plaintext" id="nama_kamar" class="nama_kamar" value="{{ $datakamar[0]->nama_kamar }}">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label">Deskripsi</label>
                                    <textarea class="form-control-plaintext" id="deskripsi" class="deskripsi" rows="5">{{ $datakamar[0]->deskripsi }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <h5><span class="badge bg-primary float-start">{{$datakamar[0]->status}}</span></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card accordion-item active">
                                ...
                                >
                                    <div class="accordion-body">
                                        <img src="/gambar/kamar/{{ $datakamar[0]->gambar }}" alt="" class="img-fluid" style="object-fit: fill;">
                                    </div>
                                </div>
                            </div>
                        </div>
