        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Informasi</span> Detail Penghuni Indekos</h4>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Akun Penghuni</h5>
                                <a href="{{ URL::previous() }}" class="btn btn-md btn-outline-secondary float-end"><i class="bx bx-undo"></i> Kembali</a>
                            </div>
                            <div class="card-body">
                            <form method="POST" action="{{ url('admin/penghuni/' . $detailpenghuni->id_user)}}" enctype="multipart/form-data">
                              @method('patch')
                              @csrf
                                <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Penghuni</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_user" name="nama_user" placeholder="John Doe" value="{{$detailpenghuni->nama_user}}"/>
                                </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{$detailpenghuni->no_telepon}}"
                                    />
                                </div>
                                </div>
                                <div class="row mb-3">
                        ...
                        <div class="card">
                            <h5 class="card-header">NonAktif kan Akun Penghuni</h5>
                            <div class="card-body">
                            <div class="mb-3 col-12 mb-0">
                                <div class="alert alert-warning">
                                <h6 class="alert-heading fw-bold mb-1">Apakah anda yakin ingin menonaktifkan akun penghuni?</h6>
                            ...
                            <form action="{{ url('/admin/penghuni/setnonaktif/' . $detailpenghuni->id_user) }}" method="post" class="d-inline">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <label class="form-check-label" for="accountActivation">Saya menyetujui untuk menonaktifkan akun penghuni ini</label>
                                </div>
                                <button type="submit" class="btn btn-danger">NonAktif Akun</button>
                            </form>
                            </div>
                        </div>
                    </div>
