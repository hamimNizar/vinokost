                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                            Apakah ada <span class="fw-bold">Penghuni Baru</span> di Vinokost?. Silakan tambahkan sekarang!
                          </p>

                          <a href="/admin/penghuni/tambah" class="btn btn-md btn-outline-primary">Tambah Penghuni</a>
                        </div>
                      </div>
                      <div class="col-sm-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            src="{{asset('theme/assets/img/illustrations/man-with-laptop-light.png')}}"
                            height="140"
                            alt="View Badge User"
                          />
                        </div>
                        ...
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="{{asset('theme/assets/img/icons/bedroom.png')}}"
                                alt="chart success"
                                class="rounded"
                              />
                            </div>
                          </div>
                          <span class="fw-semibold d-block mb-1">Kamar</span>
                          <h3 class="card-title mb-2">{{$allkamar}}</h3>
                          <small class="text-success fw-semibold"> Total Kamar</small>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="{{asset('theme/assets/img/icons/man.png')}}"
                                alt="chart success"
                                class="rounded"
                              />
                            </div>
                          ...
                          <h3 class="card-title mb-2">{{$allpenghuni}}</h3>
                          <small class="text-success fw-semibold">Total Penghuni</small>
                        </div>
                      </div>
                    </div>
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title">
                                <h5 class="text-nowrap mb-2">Pemasukan Diterima</h5>
                                <span class="badge bg-label-warning rounded-pill">tahun 2021</span>
                              </div>
                              <div class="mt-sm-auto">
                                <small class="text-success text-nowrap fw-semibold"
                                  ><i class="bx bx-chevron-up"></i> 68.2%</small
                                >
                                <h3 class="mb-0">Rp. 1.500k</h3>
                              </div>
                            </div>
