...
>
  <head>
    ...
    <title>Welcome to Vinokost | Sistem Pengelolaan Indekos ~ Malang</title>
            ...
            <div class="card-body text-center">
              ...
              <div class="app-brand justify-content-center">
                <a href="/" class="app-brand-link gap-2">
                    <img src="{{asset('theme/assets/img/logo-vertical.png')}}" alt="" style="width: 200px; height: 140px;">
                </a>
              </div>
              
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Selamat Datang 👋</h4>
              <p class="mb-4 text-center">Sistem Pengelolaan Indekos Vinokost</p>

              <a href="/penghuni/login" class="btn btn-md btn-primary p-2 mb-3"><i class="menu-icon tf-icons bx bxs-user"></i>Masuk sebagai Penghuni</a>
              <p><a href="/admin/login" class="">Masuk sebagai Admin</a></p>
