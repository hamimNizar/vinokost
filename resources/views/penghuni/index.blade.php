                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Selamat datang Penghuni 🎉</h5>
                          <p class="mb-4">
                            Apakah ada <span class="fw-bold">Tagihan Baru</span> untuk anda?. Silakan cek tagihan!
                          </p>

                          <a href="/penghuni/tagihan" class="btn btn-md btn-outline-primary">Cek Tagihan</a>
                        </div>
                      </div>
