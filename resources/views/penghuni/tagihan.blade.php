        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cek</span> Tagihan Indekos</h4>
                <div class="row">
                  @if ($datasewa)
                    <div class="col-lg-6 col-sm-12">
                        <div class="card mb-4">
                            <h5 class="card-header">Tagihan Pada Kamar <strong>{{$datasewa->nama_kamar}}</strong></h5>
                            <div class="card-body">
                                <small class="text-light fw-semibold">{{$datasewa->tanggal_sewa}}</small>
                                <dl class="row mt-2">
                                    <dt class="col-sm-4">Nama Penyewa</dt>
                                    <dd class="col-sm-8"><p>{{$datasewa->nama_user}}</p></dd>

                                    <dt class="col-sm-4">Mulai Sewa</dt>
                                    <dd class="col-sm-8"><p>{{$datasewa->mulai_sewa}}</p></dd>

                                    <dt class="col-sm-4">Akhir Sewa</dt>
                                    <dd class="col-sm-8"><p>{{$datasewa->akhir_sewa}}</p></dd>

                                    <dt class="col-sm-4">Jumlah</dt>
                                    <dd class="col-sm-8"><p>Rp. {{number_format($datasewa->jumlah,2,",",".")}}</p></dd>
                                </dl>
                                <p>Segera bayar tagihan sebelum tanggal <strong>{{date("d-m-Y", strtotime($datasewa->tanggal_sewa.'+10 days'))}}</strong></p>
                                
                                <button type="submit" class="btn btn-primary float-start" id="btn-bayar">Bayar Tagihan</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                    ...
                    <!-- disini form type hidden buat post ke db tbl transaksi -->
                    <form id="submit_response" action="{{ url('penghuni/tagihan') }}" method="post">
                      @csrf
                  ...
                  @else
                    <div class="col-lg-12 col-sm-12">
                        <div class="card">
                            <h5 class="card-header">Tagihan Pada Kamar</h5>
                            <div class="card-body">
                              <p><span class="text-bold">Belum ada tagihan bagi anda. Silakan cek jika anda telah mengkonfirmasi kelanjutan sewa indekos!</span></p>
                            </div>
                        </div>
                    </div>
                  @endif
