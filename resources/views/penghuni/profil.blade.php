        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Informasi</span> Detail Penghuni Vinokost</h4>
                    ...
                    <div class="col-xxl">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">Akun Penghuni Vinokost</h5>
                                <a href="{{ URL::previous() }}" class="btn btn-md btn-outline-secondary float-end"><i class="bx bx-undo"></i> Kembali</a>
                            </div>
                            <div class="card-body">
                            <form method="POST" action="{{ url('penghuni/profil/' . $penghunidata[0]->id_user)}}" enctype="multipart/form-data">
                              @method('patch')
                              @csrf
                                <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Penghuni</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_user" name="nama_user" value="{{$penghunidata[0]->nama_user}}"/>
                                </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{$penghunidata[0]->no_telepon}}"
                                    />
                                </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    name="username"
                                    class="form-control phone-mask"
                                    value="{{$penghunidata[0]->username}}"
                                    />
                                </div>
                                </div>
                                <hr class="my-5" />
                                <div class="row mb-3 form-password-toggle">
                                <label class="col-sm-2 col-form-label" for="basic-default-phone">Ganti Password <span class="text-muted">(Opsional)</span></label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
